...
class VtkToImage:
    ...
    def rgb(self):
        ...
        return self.window_to_image.GetOutput().GetPointData().GetScalars()
...
class ViewAdapter:
    ...
    async def _animate(self):
        ...
        content = memoryview(self._vtk_helper.rgb)
...
class ConeApp(TrameApp):
    ...
    def setup_vtk(self):
        ...
        renderWindowInteractor.GetInteractorStyle().SetCurrentStyleToTrackballCamera() # type: ignore
